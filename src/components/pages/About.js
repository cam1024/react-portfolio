...
import CameronPic from '../../images/Cameron Duran Profile pic.jpg'
...
export default function About() {
    return(
        <div>
            <img src={CameronPic} className='profilePic'></img>
            <h1 style={styles.h1Style}>About Me</h1>
            <p style={styles.textStyle}>Hello, My name is Cameron Duran.<br></br>
